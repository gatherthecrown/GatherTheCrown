...
import { FOREST_TRIAL_ROUTE_PROFILES, type ForestTrialDifficultyId, type ForestTrialRouteProfile } from '@game/shared';
...
type TrialRouteId = ForestTrialDifficultyId;
type TrialRouteProfile = ForestTrialRouteProfile;
...
export default class ForestZone extends Phaser.Scene {
  ...
  private getTrialRouteProfile(): TrialRouteProfile {
    const selected = ((this.registry.get('forestTrialRouteId') as string)
      ...
      || 'gentle').toLowerCase() as ForestTrialDifficultyId;

    return FOREST_TRIAL_ROUTE_PROFILES[selected] || FOREST_TRIAL_ROUTE_PROFILES.gentle;
  }
